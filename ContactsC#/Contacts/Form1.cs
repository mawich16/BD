...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= ASUS-PC\\SQLEXPRESS;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void loadCustomers()
        {
            ...
            currentContact = 0;
            // currentContact = -1; // Se quisermos que não sejam exibidos os campos
            ShowContact();
        }
        ...
        {
            //if (listBox1.SelectedIndex > 0) Esta linha de código está errada, pois o indice dos contactos começa em 0
        ...
        {
            // Remover ponto de interrputção para não parar a execução
            int rows = 0;
        ...
        {
            currentContact = listBox1.SelectedIndex;
            //if (currentContact <= 0) Para permitir editar o primeiro contacto basta apenas mudar para < 0 pois o indice dos contactos começa em 0
            if (currentContact < 0)
            {
