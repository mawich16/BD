...
```
As entidades sao o produto, a encomenda, o item, o fornecedor, o tipo de fornecedor e a condicao de pagamento.

Atributos Produto -> Codigo, Preco, Nome, Taxa Iva e Quantidade
Atributos Encomenda -> Numero e Data
Atributos Item -> Quantidade
Atributos Fornecedor -> Numero de Identificacao Fiscal, Nome, Morada e E-mail
Atributos Tipo de Fornecedor -> Codigo e Designaçao
Atributos Condicao de Pagemento -> Codigo, Descricao e Prazo

Uma encomenda pode ter 1 ou mais itens.
Um item pode ter 1 ou mais produtos.
Um fornecedor pode ter 1 ou mais encomendas.
Uma condicao de pagamento pode ter 1 ou mais fornecedores.
Um tipo de fornecedor pode ter 1 ou mais fornecedores.
...
```
Todas as relacoes existentes sao binarias.

Relacao Produto-Item -> A participacao da entidade Produto e obrigatoria.
Relacao Encomenda-Item -> A participacao da entidade Item e obrigatoria.
Relacao Fornecedor-Encomenda -> A participacao da entidade Encomenda e obrigatoria.
Relacao Condicao de Pagamento-Forncecedor -> A participacao da entidade Fornecedor e obrigatoria.
Relacao Tipo de Fornecedor-Fornecedor -> A participacao da entidade Fornecedor e obrigatoria.
